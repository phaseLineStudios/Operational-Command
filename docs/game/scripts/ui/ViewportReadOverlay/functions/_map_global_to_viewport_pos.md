...
func _map_global_to_viewport_pos(global_pos: Vector2) -> Vector2:
	...
	var tex_scale: float = minf(rect.size.x / tex_size.x, rect.size.y / tex_size.y)
	if tex_scale <= 0.0:
		return Vector2.INF

	var draw_size: Vector2 = tex_size * tex_scale
	...
	var local_tex: Vector2 = (global_pos - draw_pos) / tex_scale
