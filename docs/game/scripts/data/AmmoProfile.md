...
- [`func apply_defaults_if_missing(su: ScenarioUnit) -> void`](AmmoProfile/functions/apply_defaults_if_missing.md) — Fill in caps/state/thresholds if the ScenarioUnit is missing them.
