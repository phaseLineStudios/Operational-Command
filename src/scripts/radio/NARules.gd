...
func get_parser_tables() -> Dictionary:
	return {
		"callsigns": {
			...
			"xray":"XRAY","yankee":"YANKEE","zulu":"ZULU" # ← fixed YANKEE
		},
		"action_synonyms": {
			"move": OrdersParser.OrderType.MOVE, "advance": OrdersParser.OrderType.MOVE, 
			"proceed": OrdersParser.OrderType.MOVE, "shift": OrdersParser.OrderType.MOVE,
			"head": OrdersParser.OrderType.MOVE, "relocate": OrdersParser.OrderType.MOVE, 
			"fall": OrdersParser.OrderType.MOVE, "hold": OrdersParser.OrderType.HOLD, 
			"defend": OrdersParser.OrderType.DEFEND, "block": OrdersParser.OrderType.DEFEND, 
			"attack": OrdersParser.OrderType.ATTACK, "engage": OrdersParser.OrderType.ATTACK, 
			"assault": OrdersParser.OrderType.ATTACK, "recon": OrdersParser.OrderType.RECON, 
			"recce": OrdersParser.OrderType.RECON, "scout": OrdersParser.OrderType.RECON, 
			"fire": OrdersParser.OrderType.FIRE, "suppress": OrdersParser.OrderType.FIRE, 
			"shell": OrdersParser.OrderType.FIRE, "report": OrdersParser.OrderType.REPORT, 
			"status": OrdersParser.OrderType.REPORT, "cancel": OrdersParser.OrderType.CANCEL, 
		...
		"stopwords": {
			"over":true,"out":true,"roger":true,"wilco":true,"how":true,"copy":true,
			"i":true,"we":true,"be":true,"to":true,"the":true,"a":true,"an":true
		},
		"number_words": {
			"zero":0,"oh":0,"one":1,"two":2,"three":3,"four":4,"five":5,"six":6,"seven":7,"eight":8,"nine":9,
			"niner": 9, "ten":10,"eleven":11,"twelve":12,"thirteen":13,"fourteen":14,"fifteen":15,"sixteen":16,
			"seventeen":17,"eighteen":18,"nineteen":19, "twenty":20,"thirty":30,"forty":40,"fifty":50,
			"sixty":60,"seventy":70,"eighty":80,"ninety":90, "hundred":100,"thousand":1000
		},
		"prepositions": {
			"to":true,"toward":true,"towards":true,"into":true,"onto":true,"at":true,
			"on":true,"for":true,"from":true,"of":true,"in":true,"by":true
		},
		"quantity_labels": {
