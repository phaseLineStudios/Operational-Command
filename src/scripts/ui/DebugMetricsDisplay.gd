	...
	set(value):
		...
		match style:
			...
			Style.VISIBLE_COMPACT, Style.VISIBLE_DETAILED:
				...
				frame_history.visible = style == Style.VISIBLE_DETAILED
				fps_graph_container.visible = style == Style.VISIBLE_DETAILED
				total_graph_container.visible = style == Style.VISIBLE_DETAILED
				cpu_graph_container.visible = style == Style.VISIBLE_DETAILED
				gpu_graph_container.visible = style == Style.VISIBLE_DETAILED
