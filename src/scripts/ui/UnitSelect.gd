...
func _active_roles() -> PackedStringArray:
	...
	if _filter_armor.button_pressed: wanted.append("ARMOR")
	if _filter_inf.button_pressed: wanted.append("INF")
	if _filter_mech.button_pressed: wanted.append("MECH")
	if _filter_motor.button_pressed: wanted.append("MOTOR")
